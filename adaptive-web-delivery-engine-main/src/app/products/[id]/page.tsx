...
const RecommendationWidget = dynamic(() => import("@/components/RecommendationWidget"), { ssr: false, loading: () => <p className="text-sm text-slate-500">Loading recommendations…</p> });
